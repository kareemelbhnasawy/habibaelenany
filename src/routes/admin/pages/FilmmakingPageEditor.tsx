...
export function FilmmakingPageEditor() {
  ...
  async function fetchData() {
    ...
    try {
      ...
      console.error("Error fetching filmmaking data", error);
    } finally {
      setLoading(false);
    }
  }
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-400">Manage your film projects and videos.</p>
      </div>
        ...
        <div className="space-y-12">
          {sections.length === 0 && items.length === 0 && (
            <div className="text-center text-gray-500 py-12">
              No projects found. Upload some to get started.
            </div>
          )}
      ...
      <SectionOrderModal
        ...
        onClose={() => {
          ...
          fetchData(); // Refresh sections order
        }}
        category="Filmmaking"
